  ...
  return (
    <SvgIcon {...props}>
      ...
      >
        ...
        <path
          ...
          d="M451.791,489.425H60.21L32.768,253.527c-2.303-19.794,13.169-37.171,33.097-37.171h380.27c19.928,0,35.4,17.376,33.097,37.171L451.791,489.425z"
        />
        <linearGradient
          id="SVGID_2_"
          gradientUnits="userSpaceOnUse"
          ...
          gradientTransform="matrix(1.0039 0 0 -1.0039 0.1922 516.5609)"
        >
          <stop offset="0" style={{ stopColor: "#4D4D4D", stopOpacity: 0 }} />
        ...
        <path
          ...
          d="M340.155,489.425L320.2,318.292L218.264,216.357h-13.142c-0.615,8.756-11.699,165.165-21.583,219.528c-5.379,29.587-21.784,45.3-36.047,53.54H340.155z"
        />
        <linearGradient
          id="SVGID_4_"
          gradientUnits="userSpaceOnUse"
	...
	c2.046,19.125,18.092,33.546,37.326,33.546V504.807z"
        ...
        >
          ...
          <stop
            offset="0.428"
            style={{ stopColor: "#000000", stopOpacity: 0.572 }}
          />
          <stop
            offset="0.582"
            style={{ stopColor: "#6F6F6F", stopOpacity: 0.418 }}
          />
          <stop
            offset="0.692"
            style={{ stopColor: "#7A7A7A", stopOpacity: 0.308 }}
          />
          <stop
            offset="0.781"
            style={{ stopColor: "#8B8B8B", stopOpacity: 0.219 }}
          />
          <stop
            offset="0.857"
            style={{ stopColor: "#A1A1A1", stopOpacity: 0.143 }}
          />
          <stop
            offset="0.924"
            style={{ stopColor: "#BDBDBD", stopOpacity: 0.076 }}
          />
          <stop
            offset="0.984"
            style={{ stopColor: "#DCDCDC", stopOpacity: 0.016 }}
          />
          <stop offset="1" style={{ stopColor: "#E6E6E6", stopOpacity: 0 }} />
        </radialGradient>
        <path
